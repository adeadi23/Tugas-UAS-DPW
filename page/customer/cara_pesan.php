...
<html lang="en">
  <head>
    ...
    <title>Cara Pemesanan Customer</title>
    ...
    ?>
     ...
     <img src="../../img/buku31.jpg">   
      ...
      <div class="col-md-6" style="margin-left:70px; margin-top: 80px;">
        <h2><b>Selamat datang di toko buku murah.<h1 style="color:#f97b61;">Ded<b>Sec</b></h1></h2>
...
Cara Pemesanan
  ...
  <div class="footer" style="width:100%;height:270px;color:#fff;background:#d74b35;">
      ...
      <div style="margin:50px;height:120px;">
        <center>
        <ul>
        <li style="color:#f97b61"><h3><b>Tentang DedSec</b></h3></li>
        </ul></center>
          <hr>
        <ul>
        <li><center><b>DedSec</b> adalah</li>
          <li><center>Sebuah toko buku online</li>
          <li><center>yang menyediakan semua</li>
          <li><center>jenis buku dengan pemilihan Sesuai Dengan Kebutuhan Pelanggan</
        </ul>
      </div>
      </div>
      <div class="col-md-4">
      <div style="margin:50px;height:120px;">
        ...
        <ul>
          ...
          <ul>
          <li><center>Jl.Gurami No 9B</li>
          <li><center>Seketeng Sumbawa Besar</li>
          <li><center>Nusa Tenggara Barat, Indonesia</li>
          <li></li>
        </ul>
      ...
      <div style="margin:50px;height:120px;">
        ...
        <center>&copy; 2016 Karya anak banjari,am.</center>
        </div>
      </div>
  </body>
</html>
